...
values (999999, 999999, 'testTitle', 'testContent1', 0, FORMATDATETIME('2020-05-06 00:00:00', 'yyyy-MM-dd'), true,
        'description1', 999999);
--포스트 2번--
insert into posts(id, user_id, title, content, view_count, created_at, is_public, description, series_id)
values (1000000, 999999, 'testTitle2', 'testContent2', 100, FORMATDATETIME('2023-05-06 00:01:01', 'yyyy-MM-dd'), true,
        'description2', 999999);
--포스트 3번, 2번보다 오래전--
insert into posts(id, user_id, title, content, view_count, created_at, is_public, description, series_id)
values (1000001, 999999, 'testTitle3', 'testContent3', 100, FORMATDATETIME('2023-04-06 00:00:00', 'yyyy-MM-dd'), true,
        'description3', 999999);
--포스트 4번--
insert into posts(id, user_id, title, content, view_count, created_at, is_public, description, series_id)
values (1000002, 999999, 'testTitle4', 'testContent4', 200, FORMATDATETIME('2023-04-06 00:00:01', 'yyyy-MM-dd'), true,
        'description4', 999999);
--포스트 5번--
insert into posts(id, user_id, title, content, view_count, created_at, is_public, description, series_id)
